...
/**
 * Implements a base abstract class for a circle. Everything except a
 * intersects() method is implemented here. Subclass must implement the
 * intersects() method.
 **/
public abstract class Circle {
	 ...
	 * 
	 * @param factor is the scaling factor (0.8 make it 80% as big, 2.0 doubles its
	 *               size)
